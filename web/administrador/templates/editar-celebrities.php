...
<div class="contenido-modulo">
	...
	<div class="container">
		...
		<input type="hidden" name="post_type" value="celebrities">
...
<footer class="footer-modulo container">
    ...
    <a type="button" href="index.php?admin=celebrities" class="btn">Volver a lista</a>
	<a type="button" href="index.php?admin=editar-celebrities" class="btn">Agregar nuevo</a>
</footer>