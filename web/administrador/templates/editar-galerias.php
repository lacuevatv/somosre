...
<div class="contenido-modulo">
	...
	<div class="container">
		...
		<input type="hidden" name="post_type" value="galerias">
...
<footer class="footer-modulo container">
    ...
    <a type="button" href="index.php?admin=galerias" class="btn">Volver a lista</a>
	<a type="button" href="index.php?admin=editar-galerias" class="btn">Agregar nuevo</a>
</footer>